...
export default function BannerList(props) {
  ...
  function removetitle(id) {
    const todo = firebase.database().ref("BannerImage").child(id);
    todo.remove();
    message.success("Record Deleted Successfully");
  }
          ...
          <div className="row">
            <div className="col-md-12">
              <div
                ...
                style={{ marginTop: "-100px" }}
              >
                <h3 className="area-title">Banner Image Data Modification</h3>
                <p>You can edit update delete Banner Image and content here</p>
              </div>
            </div>
          </div>
          <div className="row">
