(function ($) {
  ...
  $(".portfolio-area").imagesLoaded(function () {
    ...
    $(".load-more-btn").on("click", function (event) {
      ...
      var $grid = $(".portfolio-container").isotope();
      $(this).hide();
      $(".portfolio-area .load-more").append(
        '<a className="btn btn-default load-more-btn" href="javascript:void(0)">No More Items</a>'
      );
      event.preventDefault();
    });
  });
  ...
  /*-------------------------------------------
    ...
    ---------------------------------------------*/
  $("body").append(
    '<a id="back-to-top" className="to-top-btn" href="#"><i className="fa fa-angle-up"></i></a>'
  );
